...
(function($){
    $.fn.DOPThumbnailScroller = function(options){
        ...
        ThumbnailsNavigationPrev = URL+'dopts/uploads/settings/thumbnails-navigation-prev/0.png',
        ThumbnailsNavigationPrevHover = URL+'dopts/uploads/settings/thumbnails-navigation-prev-hover/0.png',
        ThumbnailsNavigationPrevDisabled = URL+'dopts/uploads/settings/thumbnails-navigation-prev-disabled/0.png',
        ThumbnailsNavigationNext = URL+'dopts/uploads/settings/thumbnails-navigation-next/0.png',
        ThumbnailsNavigationNextHover = URL+'dopts/uploads/settings/thumbnails-navigation-next-hover/0.png',
        ThumbnailsNavigationNextDisabled = URL+'dopts/uploads/settings/thumbnails-navigation-next-disabled/0.png',

        ThumbnailLoader = URL+'dopts/uploads/settings/thumbnail-loader/0.gif',
        ThumbnailWidth = 100,
        ThumbnailHeight = 100,
        ThumbnailAlpha = 100,
        ...
        LightboxLoader = URL+'dopts/uploads/settings/lightbox-loader/0.gif',
        ...
        LightboxNavigationPrev = URL+'dopts/uploads/settings/lightbox-navigation-prev/0.png',
        LightboxNavigationPrevHover = URL+'dopts/uploads/settings/lightbox-navigation-prev-hover/0.png',
        LightboxNavigationNext = URL+'dopts/uploads/settings/lightbox-navigation-next/0.png',
        LightboxNavigationNextHover = URL+'dopts/uploads/settings/lightbox-navigation-next-hover/0.png',
        LightboxNavigationClose = URL+'dopts/uploads/settings/lightbox-navigation-close/0.png',
        LightboxNavigationCloseHover = URL+'dopts/uploads/settings/lightbox-navigation-close-hover/0.png',
        ...
        methods = {
                    ...
                    parseJSONSettings:function(){// Parse Settings.     
                        $.getJSON(prototypes.acaoBuster(Data['SettingsFilePath']), {}, function(data){
                            ...
                            ThumbnailsNavigationPrev = URL+data['ThumbnailsNavigationPrev'] || URL+'dopts/uploads/settings/thumbnails-navigation-prev/0.png';
                            ThumbnailsNavigationPrevHover = URL+data['ThumbnailsNavigationPrevHover'] || URL+'dopts/uploads/settings/thumbnails-navigation-prev-hover/0.png';
                            ThumbnailsNavigationPrevDisabled = URL+data['ThumbnailsNavigationPrevDisabled'] || URL+'dopts/uploads/settings/thumbnails-navigation-prev-disabled/0.png';
                            ThumbnailsNavigationNext = URL+data['ThumbnailsNavigationNext'] || URL+'dopts/uploads/settings/thumbnails-navigation-next/0.png';
                            ThumbnailsNavigationNextHover = URL+data['ThumbnailsNavigationNextHover'] || URL+'dopts/uploads/settings/thumbnails-navigation-next-hover/0.png';
                            ThumbnailsNavigationNextDisabled = URL+data['ThumbnailsNavigationNextDisabled'] || URL+'dopts/uploads/settings/thumbnails-navigation-next-disabled/0.png';

                            ThumbnailLoader = URL+data['ThumbnailLoader'] || URL+'DOPThumbnailScroller/assets/gui/images/ThumbnailLoader.gif';
                            ...
                            LightboxLoader = URL+data['LightboxLoader'] || URL+'dopts/uploads/settings/lightbox-loader/0.gif';
                            ...
                            LightboxNavigationPrev = URL+data['LightboxNavigationPrev'] || URL+'dopts/uploads/settings/lightbox-navigation-prev/0.png';
                            LightboxNavigationPrevHover = URL+data['LightboxNavigationPrevHover'] || URL+'dopts/uploads/settings/lightbox-navigation-prev-hover/0.png';
                            LightboxNavigationNext = URL+data['LightboxNavigationNext'] || URL+'dopts/uploads/settings/lightbox-navigation-next/0.png';
                            LightboxNavigationNextHover = URL+data['LightboxNavigationNextHover'] || URL+'dopts/uploads/settings/lightbox-navigation-next-hover/0.png';
                            LightboxNavigationClose = URL+data['LightboxNavigationClose'] || URL+'dopts/uploads/settings/lightbox-navigation-close/0.png';
                            LightboxNavigationCloseHover = URL+data['LightboxNavigationCloseHover'] || URL+'dopts/uploads/settings/lightbox-navigation-close-hover/0.png';
                        ...
                        $.getJSON(prototypes.acaoBuster(Data['ContentFilePath']), {}, function(data){
                            $.each(data, function(index){
                                if (data[index]['Enabled'] == 'true'){
                                    ...
                                    Title.push(prototypes.stripslashes(data[index]['Title']));
                                    Caption.push(prototypes.stripslashes(data[index]['Caption']));
                                    Media.push(prototypes.stripslashes(data[index]['Media']));
                                    LightboxMedia.push(prototypes.stripslashes(data[index]['LightboxMedia']));
                                    Link.push(prototypes.stripslashes(data[index]['Link']));
                                    Target.push(prototypes.stripslashes(data[index]['Target']));
                                }
                            });
